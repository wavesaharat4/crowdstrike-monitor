...
export async function processAlerts() {
    ...
    `;
            ...
            // const analyzedMessage = await getAnalysisFromExternalAI(alert);
            console.log(`      ผลวิเคราะห์จาก AI: ${analyzedMessage}`);
            // await sendWebhookAlert({ ...alert, customer_message: aiResponse });
